...
const HeaderImageWithDescription = ({ imageUrl, description }) => {
  return (
    ...
    <div className="flex items-center justify-center w-full h-screen">
      <div className="flex items-center justify-center bg-purple-950 text-white p-4 rounded-lg" style={{ width: '90%' }}>
...
const ImageWithDescription = ({ imageUrl, description }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center mb-4 w-full md:w-96 h-96 bg-purple-950 text-white p-4 rounded-lg relative overflow-hidden" style={{ width: '90%', height:'550px' }}>
